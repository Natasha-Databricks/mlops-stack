...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops_demo_jan24/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops-demo-jan24/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops-demo-jan24/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlops-demo-jan24-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.natasha_mlops.mlops-demo-jan24-model", "Full (Three-Level) Model Name")
