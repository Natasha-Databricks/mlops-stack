...
[ML Config](../mlops_demo_jan24/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mlops_demo_jan24/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [mlops-demo-jan24/databricks.yml](../mlops_demo_jan24/databricks.yml)
and [mlops-demo-jan24/assets/ml-artifacts-asset.yml](../mlops_demo_jan24/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [mlops-demo-jan24/assets/README.md](../mlops_demo_jan24/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../mlops_demo_jan24/assets/README.md)  to propose, test, and deploy
