...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-demo-jan24-run-tests.yml) 
...
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/mlops-demo-jan24/mlops-demo-jan24-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/mlops-demo-jan24/mlops-demo-jan24-model)
. 
