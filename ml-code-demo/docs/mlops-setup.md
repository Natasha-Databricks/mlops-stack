...
[ML Config](../mlops_flatiron/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mlops_flatiron/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [mlops-flatiron/databricks.yml](../mlops_flatiron/databricks.yml)
and [mlops-flatiron/assets/ml-artifacts-asset.yml](../mlops_flatiron/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [mlops-flatiron/assets/README.md](../mlops_flatiron/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../mlops_flatiron/assets/README.md)  to propose, test, and deploy
