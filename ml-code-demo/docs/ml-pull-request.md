...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-flatiron-run-tests.yml) 
...
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/mlops-flatiron/mlops-flatiron-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/mlops-flatiron/mlops-flatiron-model)
. 
