...
[ML Config](../natasha_mlops_project/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore natasha_mlops_project/databricks-resources/README.md
...
Follow the instructions in [natasha-mlops-project/databricks-resources/README.md](../natasha_mlops_project/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../natasha_mlops_project/databricks-resources/README.md)  to propose, test, and deploy
