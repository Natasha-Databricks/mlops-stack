...
Opening a pull request will trigger a[workflow](../.github/workflows/natasha-mlops-project-run-tests.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-natasha-mlops-project-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-natasha-mlops-project-model)
